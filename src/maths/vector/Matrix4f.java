...
/**
 * @author vgl
 * Column major implementation of a 4x4 matrix
 * <br>
 * <strong> First number is columns, second is rows (eg m31 = 4th
 * column, 2nd row)</strong>
 * <br>
 * <br>
 * Most methods of the class return a pointer to this, allowing for
 * chained mathematical operations such as <br>
 * <code> matrix.add(matrix2).multiply(3)); </code>
 * <br>
 * <strong> Note : none of the methods instead of <code> copy </code>
 * create any new object, but return a pointer to this, so if you
 * would like to keep your original vector after an operation, just
 * place a <code> .copy() </code> before you execute an operation
 * <br>
 * eg:
 * </strong>
 * <br>
...
public class Matrix4f implements java.io.Serializable {
	...
	public Matrix4f multiply(Matrix4f other) {
		...
		float m00 = this.m00 * other.m00
				+ this.m10 * other.m01 + this.m20 * other.m02 + this.m30 * other.m03;
		float m01 = this.m01 * other.m00
				+ this.m11 * other.m01 + this.m21 * other.m02 + this.m31 * other.m03;
		float m02 = this.m02 * other.m00
				+ this.m12 * other.m01 + this.m22 * other.m02 + this.m32 * other.m03;
		float m03 = this.m03 * other.m00
				+ this.m13 * other.m01 + this.m23 * other.m02 + this.m33 * other.m03;
		float m10 = this.m00 * other.m10
				+ this.m10 * other.m11 + this.m20 * other.m12 + this.m30 * other.m13;
		float m11 = this.m01 * other.m10
				+ this.m11 * other.m11 + this.m21 * other.m12 + this.m31 * other.m13;
		float m12 = this.m02 * other.m10
				+ this.m12 * other.m11 + this.m22 * other.m12 + this.m32 * other.m13;
		float m13 = this.m03 * other.m10
				+ this.m13 * other.m11 + this.m23 * other.m12 + this.m33 * other.m13;
		float m20 = this.m00 * other.m20
				+ this.m10 * other.m21 + this.m20 * other.m22 + this.m30 * other.m23;
		float m21 = this.m01 * other.m20
				+ this.m11 * other.m21 + this.m21 * other.m22 + this.m31 * other.m23;
		float m22 = this.m02 * other.m20
				+ this.m12 * other.m21 + this.m22 * other.m22 + this.m32 * other.m23;
		float m23 = this.m03 * other.m20
				+ this.m13 * other.m21 + this.m23 * other.m22 + this.m33 * other.m23;
		float m30 = this.m00 * other.m30
				+ this.m10 * other.m31 + this.m20 * other.m32 + this.m30 * other.m33;
		float m31 = this.m01 * other.m30
				+ this.m11 * other.m31 + this.m21 * other.m32 + this.m31 * other.m33;
		float m32 = this.m02 * other.m30
				+ this.m12 * other.m31 + this.m22 * other.m32 + this.m32 * other.m33;
		float m33 = this.m03 * other.m30
	...
	public static Matrix4f translation(Vector3f translation) {
		...
		trans.m30 += trans.m00 * translation.x
				+ trans.m10 * translation.y + trans.m20 * translation.z;
		trans.m31 += trans.m01 * translation.x
				+ trans.m11 * translation.y + trans.m21 * translation.z;
		trans.m32 += trans.m02 * translation.x
				+ trans.m12 * translation.y + trans.m22 * translation.z;
		trans.m33 += trans.m03 * translation.x
				+ trans.m13 * translation.y + trans.m23 * translation.z;
		return trans;
	}
	...
	public String toString() {
		return "Matrix4f [m00="
				+ m00 + ", m01=" + m01 + ", m02=" + m02 + ", m03=" + m03 + ", m10=" + m10 + ", m11="
				+ m11 + ", m12=" + m12 + ", m13=" + m13 + ", m20=" + m20 + ", m21=" + m21 + ", m22="
				+ m22 + ", m23=" + m23 + ", m30=" + m30 + ", m31=" + m31 + ", m32=" + m32 + ", m33="
				+ m33 + "]";
	}
